<div>
    ...
    <form method="POST" wire:submit="save">
        <div>
            ...
            <input id="title" wire:model.blur="form.title" wire:keydown="validateTitle" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm text-gray-700" type="text" />
