    ...
    <table class="min-w-full border divide-y divide-gray-200">
        ...
        @forelse($devices as $device)
            <tr class="bg-white">
                ...
                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                    <a wire:click="edit({{$device->id}})" href="#" class="mt-4 rounded-md bg-gray-800 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white hover:bg-gray-700">
                        Edit
                    </a>
                </td>
            </tr>
        @empty
            <tr>
                <td class="px-6 py-2 text-sm leading-5 text-gray-900 whitespace-no-wrap" colspan="3">No devices found.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
            ...
            <form wire:submit="update" class="w-full">
                <div class="flex flex-col items-start p-4">
                    <div class="flex w-full items-center border-b pb-4">
                        <div class="text-lg font-medium text-gray-900">Edit Device</div>
