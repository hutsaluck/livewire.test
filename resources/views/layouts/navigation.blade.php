        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('users.index')" wire:navigate :active="request()->routeIs('users.index')">
                        {{ __('Users') }}
                    </x-nav-link>
                    <x-nav-link :href="route('posts')" wire:navigate :active="request()->routeIs('posts')">
                        {{ __('Posts') }}
                    </x-nav-link>
                    <x-nav-link :href="route('posts.create')" wire:navigate :active="request()->routeIs('posts.create')">
                        {{ __('Create Post') }}
                    </x-nav-link>
                </div>
            </div>
